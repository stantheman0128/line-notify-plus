            ...
            Card(
                ...
                Column(modifier = Modifier.padding(20.dp)) {
                    ...
                    ChangelogEntry(
                        "v1.3.8",
                        listOf(
                            stringResource(R.string.changelog_1_3_8_apple_dupe),
                        )
                    )
                    ...
                    ChangelogEntry(
                        "v1.3.7",
                        listOf(
                            stringResource(R.string.changelog_1_3_7_mute),
                        )
                    )
                    ...
                    ChangelogEntry(
                        "v1.3.6",
                        listOf(
                            stringResource(R.string.changelog_1_3_6_self_avatar),
                        )
                    )
                    ...
                    ChangelogEntry(
                        "v1.3.4",
                        listOf(
                            stringResource(R.string.changelog_1_3_4_android16),
                        )
                    )
                    ...
                    ChangelogEntry(
                        "v1.3.3",
                        listOf(
                            stringResource(R.string.changelog_1_3_3_group_dupe),
                        )
                    )
